...
def preprocess_images_sequential(input_sequentiel, output_sequentiel):
    ...
    print(f"Sequential preprocessing time: {end_time - start_time:.2f} seconds")
...
def process_images_sequential(output_sequentiel, model):
    ...
    cpu_usage, temperature = get_system_metrics()
    print(f"Sequential inference time: {end_time - start_time:.2f} seconds")
    print(f"CPU Usage: {cpu_usage}%")
    print(f"Temperature: {temperature}°C")

# Exécution du prétraitement et de l'inférence séquentiels
preprocess_images_sequential(input_sequentiel, output_sequentiel)
process_images_sequential(output_sequentiel, model)
